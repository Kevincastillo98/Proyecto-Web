...
function validate ( )
{
    ...
    if ( !USERNAME.val() || USERNAME.val().length < 5  )
    {
        ...
        USERNAME_MSG.html( "El username debe de tener 5 caracteres o mas" );
        USERNAME_MSG.show();
    ...
    {
        USERNAME_MSG.html("El username debe de tener minusculas");
        USERNAME_MSG.show();
        valid = false;
    }
    ...
    {
        PASSWORD_MSG.html("El password debe de tener al menos 8 caracteres");
        PASSWORD_MSG.show();
        valid = false;
    }
    ...
    {
        CONFIRM_MSG.html("Las contraseñas no coinsiden");
        CONFIRM_MSG.show();
        valid = false;
    }
    ...
    if ( !FNAME.val() )
    {
        FNAME_MSG.html("EL nombre no puede estar vacio");
        FNAME_MSG.show();
        valid = false;
    }
    ...
    if ( !LNAME.val() )
    {
        LNAME_MSG.html("El apellido no puede estar vacio");
        LNAME_MSG.show();
        valid = false;
    }
    ...
    if ( atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length ) {
        EMAIL_MSG.html("Debes de ingresar un mail valido");
        EMAIL_MSG.show();
        valid = false;
    }
